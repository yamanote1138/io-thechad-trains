...
$(document).ready(function() {
	...
	var camera = parseInt(camdiv.attr('data-camera'), 10);
	var maxcam = parseInt(camdiv.attr('data-camcount'), 10)-1;
	var currSlide = parseInt(camdiv.attr('data-start'), 10);
	var prevCam = (camera === 0) ? maxcam : (camera-1);
	var nextCam = (camera === maxcam) ? 0 : (camera+1);
